...
const ResidentLayout = () => {
  ...
  const menuItems = [
    ...
    { icon: FileText, label: 'Complaints', path: '/resident/complaints' },
    { icon: DollarSign, label: 'Maintenance', path: '/resident/maintenance' },
    { icon: Receipt, label: 'Expenses', path: '/resident/expenses' },
    { icon: FileCheck, label: 'NOC', path: '/resident/noc' },
    { icon: Bell, label: 'Notices', path: '/resident/notices' },
    { icon: Calendar, label: 'Events', path: '/resident/events' },
    { icon: Users, label: 'Visitors', path: '/resident/visitors' },
    { icon: Building, label: 'Amenities', path: '/resident/amenities' },
    { icon: Car, label: 'Parking', path: '/resident/parking' },
  ]
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {user?.flatNo || 'Flat'} • {user?.residentType === 'owner' ? 'Owner' : 'Tenant'}
                  </p>
                </div>
              </div>
            </div>
